...
(function ($) {
    ...
    $('div.rateit').rateit();
    $('div.rateit').bind('hover', function (event,value) { $(this).attr('title', value); });
	$('div.rateit').bind('rated', function (event, value) { 
		MovieManagementService.rateMovie(getParameterByName('id'),
				value,callbackRating);		
	});
	
	function callbackRating(movie)
	{	
		$('div.rateit').rateit('value',movie.rating);
	}
