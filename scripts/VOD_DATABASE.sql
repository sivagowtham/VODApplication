...
DROP TABLE "VODAPP"."TBL_CATEGORIES";
...
CREATE TABLE "VODAPP"."TBL_CATEGORIES" ("CATEGORY_ID" INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1), "CATEGORY_TITLE" VARCHAR(500) NOT NULL, "DISPLAY_ORDER" INTEGER NOT NULL);
-- ----------------------------------------------
...
ALTER TABLE "VODAPP"."TBL_CATEGORIES" ADD CONSTRAINT "SQL140705004447710" PRIMARY KEY ("CATEGORY_ID");

-- FOREIGN
ALTER TABLE "VODAPP"."TBL_MOVIES" ADD CONSTRAINT "FK_MOVIE_CATEGORY_ID" FOREIGN KEY ("CATEGORY_ID") REFERENCES "VODAPP"."TBL_CATEGORIES" ("CATEGORY_ID") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- DATA INSERTION
INSERT INTO "VODAPP"."TBL_CATEGORIES" (CATEGORY_TITLE, DISPLAY_ORDER) VALUES ('Action/Adventure', 1);
INSERT INTO "VODAPP"."TBL_CATEGORIES" (CATEGORY_TITLE, DISPLAY_ORDER) VALUES ('Drama', 2);
INSERT INTO "VODAPP"."TBL_CATEGORIES" (CATEGORY_TITLE, DISPLAY_ORDER) VALUES ('Sci-Fi/Thriller', 3);

INSERT INTO "VODAPP"."TBL_MOVIES" (TITLE,DESCRIPTION,DIRECTOR,ACTORS,CATEGORY_ID,ADDED_ON,POSTER_URL,VIDEO_URL,IMDB_ID,IS_VISIBLE) VALUES ('X-Men: Days of Future Past','The X-Men send Wolverine to the past in a desperate effort to change history and prevent an event that results in doom for both humans and mutants.','Bryan Singer','Hugh Jackman, James McAvoy, Michael Fassbender, Jennifer Lawrence',1,{d '2014-07-05'},'http://ia.media-imdb.com/images/M/MV5BMTA2MDU0MjUxNDNeQTJeQWpwZ15BbWU4MDEwOTAwNTAx._V1_SX300.jpg','movie03.mp4','tt1877832','Y');
INSERT INTO "VODAPP"."TBL_MOVIES" (TITLE,DESCRIPTION,DIRECTOR,ACTORS,CATEGORY_ID,ADDED_ON,POSTER_URL,VIDEO_URL,IMDB_ID,IS_VISIBLE) VALUES ('Transcendence','A scientist''s drive for artificial intelligence, takes on dangerous implications when his consciousness is uploaded into one such program.','Wally Pfister','Johnny Depp, Rebecca Hall, Paul Bettany, Cillian Murphy',2,{d '2014-07-05'},'http://ia.media-imdb.com/images/M/MV5BMTc1MjQ3ODAyOV5BMl5BanBnXkFtZTgwNjI1NDQ0MTE@._V1_SX300.jpg','movie01.mp4','tt2209764','Y');
INSERT INTO "VODAPP"."TBL_MOVIES" (TITLE,DESCRIPTION,DIRECTOR,ACTORS,CATEGORY_ID,ADDED_ON,POSTER_URL,VIDEO_URL,IMDB_ID,IS_VISIBLE) VALUES ('Godzilla','An enormous, radioactively mutated lizard runs rampant in Manhattan.','Roland Emmerich','Matthew Broderick, Jean Reno, Maria Pitillo, Hank Azaria',3,{d '2014-07-05'},'http://ia.media-imdb.com/images/M/MV5BMTgyMjE1NDczN15BMl5BanBnXkFtZTYwNDIwNjg5._V1_SX300.jpg','movie02.mp4','tt0120685','Y');
INSERT INTO "VODAPP"."TBL_MOVIES" (TITLE,DESCRIPTION,DIRECTOR,ACTORS,CATEGORY_ID,ADDED_ON,POSTER_URL,VIDEO_URL,IMDB_ID,IS_VISIBLE) VALUES ('Captain America: The Winter Soldier','Steve Rogers struggles to embrace his role in the modern world and battles a new threat from old history: the Soviet agent known as the Winter Soldier.','Anthony Russo, Joe Russo','Chris Evans, Samuel L. Jackson, Scarlett Johansson, Robert Redford',1,{d '2014-07-05'},'http://ia.media-imdb.com/images/M/MV5BMzA2NDkwODAwM15BMl5BanBnXkFtZTgwODk5MTgzMTE@._V1_SX300.jpg','movie04.mp4','tt1843866','Y');
INSERT INTO "VODAPP"."TBL_MOVIES" (TITLE,DESCRIPTION,DIRECTOR,ACTORS,CATEGORY_ID,ADDED_ON,POSTER_URL,VIDEO_URL,IMDB_ID,IS_VISIBLE) VALUES ('The Social Network','Harvard student Mark Zuckerberg creates the social networking site that would become known as Facebook, but is later sued by two brothers who claimed he stole their idea, and the cofounder who was later squeezed out of the business.','David Fincher','Jesse Eisenberg, Rooney Mara, Bryan Barter, Dustin Fitzsimons',2,{d '2014-07-08'},'http://ia.media-imdb.com/images/M/MV5BMTM2ODk0NDAwMF5BMl5BanBnXkFtZTcwNTM1MDc2Mw@@._V1_SX300.jpg','movie05.mp4','tt1285016','Y');
...
--Testing movie data 
insert into movie_test values(3,'action',5)
insert into movie_test values(4,'romantic',4);
insert into movie_test values(5,'action',5);
insert into movie_test values(6,'thriller',3);
insert into movie_test values(7,'romantic',4);
insert into movie_test values(8,'mystery',4);
insert into movie_test values(9,'action',4);
insert into movie_test values(10,'romantic',3);
insert into movie_test values(11,'comedy',4);
insert into movie_test values(12,'romantic',5);
insert into movie_test values(13,'action',2);
insert into movie_test values(14,'romantic',3);
insert into movie_test values(15,'comedy',2);
insert into movie_test values(16,'action',3);
insert into movie_test values(17,'comedy',3);
insert into movie_test values(18,'action',4);
insert into movie_test values(19,'romantic',1);
insert into movie_test values(20,'romantic',3);
--Favorite Testing Data
INSERT INTO "VODAPP"."TBL_USER_FAVORITES" (MOVIE_ID,USER_ID) VALUES (1,1);
INSERT INTO "VODAPP"."TBL_USER_FAVORITES" (MOVIE_ID,USER_ID) VALUES (2,1);
INSERT INTO "VODAPP"."TBL_USER_FAVORITES" (MOVIE_ID,USER_ID) VALUES (3,1);
INSERT INTO "VODAPP"."TBL_USER_FAVORITES" (MOVIE_ID,USER_ID) VALUES (4,1);
INSERT INTO "VODAPP"."TBL_USER_FAVORITES" (MOVIE_ID,USER_ID) VALUES (5,1);
INSERT INTO "VODAPP"."TBL_USER_FAVORITES" (MOVIE_ID,USER_ID) VALUES (1,2);
INSERT INTO "VODAPP"."TBL_USER_FAVORITES" (MOVIE_ID,USER_ID) VALUES (2,2);
INSERT INTO "VODAPP"."TBL_USER_FAVORITES" (MOVIE_ID,USER_ID) VALUES (3,2);
INSERT INTO "VODAPP"."TBL_USER_FAVORITES" (MOVIE_ID,USER_ID) VALUES (4,2);
INSERT INTO "VODAPP"."TBL_USER_FAVORITES" (MOVIE_ID,USER_ID) VALUES (5,2);
INSERT INTO "VODAPP"."TBL_USER_FAVORITES" (MOVIE_ID,USER_ID) VALUES (1,3);
INSERT INTO "VODAPP"."TBL_USER_FAVORITES" (MOVIE_ID,USER_ID) VALUES (2,3);
INSERT INTO "VODAPP"."TBL_USER_FAVORITES" (MOVIE_ID,USER_ID) VALUES (3,3);
INSERT INTO "VODAPP"."TBL_USER_FAVORITES" (MOVIE_ID,USER_ID) VALUES (4,3);
