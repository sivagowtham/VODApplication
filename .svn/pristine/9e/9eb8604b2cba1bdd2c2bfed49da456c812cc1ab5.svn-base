...
public class ReportDTO implements Serializable{
	...
	public ReportDTO(Report report){
		...
		this.firstName = report.getFirstName();
		this.lastName = report.getLastName();
		this.isActive = report.getIsActive();
		this.isAdmin = report.getIsAdmin();
		this.moviesPurchased = report.getMoviesPurchased();
		this.moviesRented = report.getMoviesRented();
		this.maxActivity = report.getMaxActivity();
		this.movieId = report.getMovieId();
		this.imdbId = report.getImdbId();
		this.title = report.getTitle();
		this.category = report.getCategory();
		this.numOfPurchases = report.getNumOfPurchases();
		this.numOfRents = report.getNumOfRents();
